...
import RJS from '../images/icons8-html5-70.png';
import MaterialUI from '../images/icons8-html5-70.png';
import Webflow from '../images/icons8-html5-70.png';
import Figma from '../images/icons8-html5-70.png';
import Anaconda from '../images/icons8-html5-70.png';
import Github from '../images/icons8-html5-70.png';
  ...
  return (
    <div className="skills">
      <div className="container">
        <div className="cards">
          <div className="title"><h1>&#60;competências /&#62;</h1></div>
          <div className="card">
            <BootstrapTooltip placement="top" title="Html 5">
                <img src={Html5} className="skills-img" alt="Html5"/>
            </BootstrapTooltip>
          </div>
          <div className="card">
